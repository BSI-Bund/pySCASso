...
# ordered lists and is contained in the UE EPS security capabilities. The eNB checks the message
# authentication code on the SECURITY MODE COMPLETE message.
