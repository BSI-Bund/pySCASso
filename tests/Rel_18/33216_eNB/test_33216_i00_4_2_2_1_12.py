...
# from eNB to UE.
# 4. The tester proceeds the testing based on the parameters (algorithm identifier and algorithm
# distinguisher) present in the AS SMC command message.
...
def test_33216_i00__TC_eNB_DL_Cipher():
