...
# Execution Steps:
# ----------------
# 1. The tester shall capture the NAS Security Mode Command procedure taking place between UE and
...
# 4. The tester shall check whether the replayed NAS Security Mode Complete message was not
# processed by the AMF by capturing traffic over the N1 interface to see if no corresponding
# response message was sent by the AMF. If applicable, AMF application logs could be checked for
# the rejection of the replayed NAS Security Mode Complete message.
#
# Expected Results:
# ----------------
