...
from scas.packet_type.nas_5gs import (RegistrationRequest, SecurityModeCommand,
...
# Execution Steps:
# ----------------
# 1. The tester triggers the UE to send a Registration Request with Initial Registration type to
# the AMF unders test.
...
# 4. The tester changes the default order of the list of ordered NAS integrity algorithms on the
# AMF to one other valid configuration and repeats step 1-3 once.
#
# Expected Results:
# ----------------
...
def test_33512_g60_AMF_TC_NAS_INT_SELECTION_USE_AMF(provide_running_core, provide_core_config,
    ...
    LOGGER.info(f"Security Mode Complete MAC: {SMComp.msg_auth_code()}")

    # TODO: Change list order and retest

    skip("WIP - Change list order and retest")
