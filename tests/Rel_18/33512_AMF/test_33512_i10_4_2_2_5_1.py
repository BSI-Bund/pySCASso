...
# ----------------
# Test case 1:
# Upon receiving Registration Request message of type "initial registration" from a UE (triggered
# by the tester), the AMF sends a new 5G-GUTI to the UE during the registration procedure.
# Test case 2:
# Upon receiving Registration Request message of type "mobility registration update" from a UE
# (triggered by the tester), the AMF sends a new 5G-GUTI to the UE during the registration
# procedure.
# Test case 3:
# Upon receiving Service Request message sent by the UE in response to a Paging message (triggered
# by the tester), the AMF sends a new 5G-GUTI to the UE.
# Test case 4:
# The AMF under test is triggered by the tester to page the UE in CM Idle with Suspend Indicator.
# After paging the UE in CM-Idle with Suspend indicator, the AMF shall send a new 5G-GUTI to the
# UE.
...
def test_33512_i10__TC_5G_GUTI_ALLOCATION_AMF():
