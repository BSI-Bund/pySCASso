...
# Source: 33514-i10.md
# Section: 4.2.1.1
# Title: De-concealment of SUPI from the SUCI based on the protection scheme used to generate the
# SUCI
# Purpose:
...
# 1. Tester shall filter the Nudm_UEAuthentication_Get Response message sent from UDM to AUSF over
