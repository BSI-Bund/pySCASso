...
# expert knowledge of the operating system(s) used in the network product, and operating system
# documentation. Unix® example: To list files with SUID and SGID permissions and Linux®
# capabilities, the following commands can be used:
...
def test_33117_i10__TC_OS_PRIVILEGE():
