...
# network name retrieved from the Nudm_Authentication_Get Request message and the serving network
...
# Nudm_Authentication_Get Response message and the SUPI retrieved from the
...
def test_33514_g40_TC_AUTH_STATUS_STORE_UDM(provide_running_core, provide_core_config,
    ...
    LOGGER.info("Nudm_UEAuthentication_ResultConfirmation Request message found")
