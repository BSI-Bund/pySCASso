...
# Execution Steps:
# ----------------
# 1. The tester runs a network port scanner (e.g. nmap) towards if1 and verifies that the
# configured services are open/reachable.
# 2. The tester runs a network port scanner (e.g. nmap) towards if2 and verifies that the
# configured services are not open/reachable.
#
# Expected Results:
# ----------------
...
def test_33117_g80_TC_RESTRICTED_REACHIBILITY_OF_SERVICES():
