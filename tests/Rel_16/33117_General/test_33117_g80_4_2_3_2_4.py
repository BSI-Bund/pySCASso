...
# 2. The tester shall establish a secure connection between the network product and the peer and
# verify that all protocol versions and combinations of cryptographic algorithms that are mandated
# by the security profile are supported by the network product.
# 3. The tester shall try to establish a secure connection between the network product and the peer
...
def test_33117_g80_TC_PROTECT_DATA_INFO_TRANSFER_1():
