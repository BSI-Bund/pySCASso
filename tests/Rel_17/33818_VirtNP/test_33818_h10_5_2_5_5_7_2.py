...
# Source: 33818-h10.md
# Section: 5.2.5.5.7.2
# Title: Potential security functional requirements on executive environment provision
# Purpose:
...
# 1. The tester utilizes the virtualisation layer to change the resource state of VNF
# (e.g. change vCPU size of the VNF).
...
def test_33818_h10_TC_SECURE_EXECUTIVE_ENVIRONMENT_PROVISION():
