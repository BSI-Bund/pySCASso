...
# ----------------
# A. Test Case 1
# 1. The UE sends the S-NSSAI that require NSSAA to the AMF under test using registration request
# message.
...
# For test case 2, the AMF aborts the PDU session establishment procedure by sending back the 5GSM
# message to the UE.


def test_33512_h30_TC_VALIDTATION_SNSSAI_IN_PDU_REQUEST():
